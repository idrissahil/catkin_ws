...
"""autogenerated by genpy from rpl_exploration/FlyToActionResult.msg. Do not edit."""
import sys
...
class FlyToActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rpl_exploration/FlyToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rpl_exploration/FlyToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FlyToActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rpl_exploration.msg.FlyToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rpl_exploration.msg.FlyToResult()
