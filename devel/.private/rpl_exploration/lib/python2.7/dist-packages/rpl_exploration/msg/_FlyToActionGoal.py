...
"""autogenerated by genpy from rpl_exploration/FlyToActionGoal.msg. Do not edit."""
import sys
...
class FlyToActionGoal(genpy.Message):
  _md5sum = "0f976a59bdc328547eecdf07b04a9787"
  _type = "rpl_exploration/FlyToActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','rpl_exploration/FlyToGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FlyToActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = rpl_exploration.msg.FlyToGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = rpl_exploration.msg.FlyToGoal()
