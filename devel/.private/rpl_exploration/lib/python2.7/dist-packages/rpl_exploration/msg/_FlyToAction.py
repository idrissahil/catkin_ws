...
"""autogenerated by genpy from rpl_exploration/FlyToAction.msg. Do not edit."""
import sys
...
import rpl_exploration.msg
import actionlib_msgs.msg
import std_msgs.msg

class FlyToAction(genpy.Message):
  _md5sum = "90a356dab02b4c943aec91b372f494a3"
  _type = "rpl_exploration/FlyToAction"
...
"""
  ...
  _slot_types = ['rpl_exploration/FlyToActionGoal','rpl_exploration/FlyToActionResult','rpl_exploration/FlyToActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FlyToAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rpl_exploration.msg.FlyToActionGoal()
      if self.action_result is None:
        self.action_result = rpl_exploration.msg.FlyToActionResult()
      if self.action_feedback is None:
        self.action_feedback = rpl_exploration.msg.FlyToActionFeedback()
    else:
      self.action_goal = rpl_exploration.msg.FlyToActionGoal()
      self.action_result = rpl_exploration.msg.FlyToActionResult()
      self.action_feedback = rpl_exploration.msg.FlyToActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.action_feedback.feedback.distance_to_target))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.distance_to_target,) = _get_struct_f().unpack(str[start:end])
      return self
