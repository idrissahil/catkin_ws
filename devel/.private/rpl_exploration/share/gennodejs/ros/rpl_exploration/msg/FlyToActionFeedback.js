...
let FlyToFeedback = require('./FlyToFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FlyToActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FlyToFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FlyToFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FlyToActionFeedback(null);
    ...
    data.feedback = FlyToFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FlyToActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FlyToFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FlyToFeedback()
    }
...
module.exports = FlyToActionFeedback;
