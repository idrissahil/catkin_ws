...
let rrtFeedback = require('./rrtFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class rrtActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = rrtFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new rrtActionFeedback(null);
    ...
    data.feedback = rrtFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new rrtActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = rrtFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new rrtFeedback()
    }
...
module.exports = rrtActionFeedback;
