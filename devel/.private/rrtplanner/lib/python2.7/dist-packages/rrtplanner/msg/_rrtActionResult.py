...
"""autogenerated by genpy from rrtplanner/rrtActionResult.msg. Do not edit."""
import sys
...
class rrtActionResult(genpy.Message):
  _md5sum = "a1193fc3c7b443d64204ae9c528370e5"
  _type = "rrtplanner/rrtActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rrtplanner/rrtResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rrtActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rrtplanner.msg.rrtResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rrtplanner.msg.rrtResult()
