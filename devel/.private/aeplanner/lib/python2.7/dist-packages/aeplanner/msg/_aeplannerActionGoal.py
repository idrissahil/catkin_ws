...
"""autogenerated by genpy from aeplanner/aeplannerActionGoal.msg. Do not edit."""
import sys
...
class aeplannerActionGoal(genpy.Message):
  _md5sum = "0e6430e9e347d7e85e0193e9eec8ba55"
  _type = "aeplanner/aeplannerActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','aeplanner/aeplannerGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(aeplannerActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = aeplanner.msg.aeplannerGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = aeplanner.msg.aeplannerGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.goal.actions_taken))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.actions_taken,) = _get_struct_i().unpack(str[start:end])
      return self
