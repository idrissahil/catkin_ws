...
"""autogenerated by genpy from aeplanner/aeplannerActionFeedback.msg. Do not edit."""
import sys
...
class aeplannerActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "aeplanner/aeplannerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','aeplanner/aeplannerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(aeplannerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = aeplanner.msg.aeplannerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = aeplanner.msg.aeplannerFeedback()
